        ...
        <div class="account-settings">
            <div class="user-profile">
                <div class="user-avatar">
                    <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt=" edit profile">
                </div>
                
            <br></div>
            <div class="about">
                <h5 class="user-name">Ingabire</h5>
                <h6 class="user-email">kabaj@gmail.com</h6>
            </div>
...
<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
 ...
 <label for="birthday">Birthday:</label>
  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group"> <input type="date" id="birthday" name="birthday"></div></div>
          <label for="bio">Biography:</label>
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="form-group"> <textarea id="bio" name="user_bio"></textarea>
                </div></div>
