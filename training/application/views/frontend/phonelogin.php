...
.btnSubmit {
	...
	<div class="container">
		...
		<form id="frm-mobile-verification">
			...
			<div class="row"><input type="button" class="btnSubmit" value="Send"
				onClick="send"></div>
				<div class="form-row">
		<label>SMS is sent to Your Mobile Number</label>		
	</div>
	...
	<div class="row">
		<input id="verify" type="button" class="btnSubmit" value="Verify" onClick="verifyOTP();">		
	</div>
		</form></center>
	</div>
